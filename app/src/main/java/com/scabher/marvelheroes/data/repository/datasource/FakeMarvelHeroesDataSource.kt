...
class FakeMarvelHeroesDataSource : MarvelHeroesDataSource {
    ...
    override fun getMarvelHeroesList(): Flowable<List<MarvelHeroEntity>> {
        return Flowable.just(
                arrayListOf(
                        MarvelHeroEntity(0, "Fake", "https://i.blogs.es/30cb7a/blackpanther5/450_1000.jpg"),
                        MarvelHeroEntity(1, "Fake 2", "https://thefreakchoice.com/2833-home_default/cojin-arrow-flechas-verde-.jpg")
                )
        )
    }
